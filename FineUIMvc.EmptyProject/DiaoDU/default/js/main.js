...
$(function () {
    var vUrl = parseUrl();
    tempID = vUrl.FMapTempID;
    $('.mapIframe').attr('src', '../Web/WebForm/InPage/qingpuMapShow.html?id=' + tempID);
    resetLayout();
    var Fo = vUrl.Fo;
...
function logoPicChange(Fo) {
    ...
    if (styleElem.styleSheet) {//IE  
        styleElem.styleSheet.cssText +=".pageHeader {                    "+
         "   position: relative;                                         "+
         "   width: 100%;                                                "+
         "   height: 50px;                                               "+
         "    border-bottom: 1px solid #0f405c;                          "+
         "    background: url(/DiaoDU/" + Fo + "/img/logo.png) no-repeat 24px 10px;      " +
         "}                                                              "
...
//            //}
//            $.ajax({
//                url: '/DiaoDU/Web/Service/Map_Template.ashx?method=inserttemplate',
//                data: {
//                    'FMapTempName': name
//                },
//                success: function (dat) {
...
function topNavChildClick() {
    $('.headerNav li.li_fenqu .childList li').click(function () {
        ...
        switch (index) {
            ...
            //        shadeClose: true, //点击遮罩关闭层
            //        area: ['98%', '98%'],
            //        content: '/DiaoDU/Web/WebForm/MapTools/listIndex.html'
            //    });
                break;
            }
            case 1: {
                ...
                //    shadeClose: true, //点击遮罩关闭层
                //    area: ['98%', '98%'],
                //    content: '/DiaoDU/Web/WebForm/InPage/timeLine.html'
                //});
                break;
            }
            case 2: {
                ...
                //    shadeClose: true, //点击遮罩关闭层
                //    area: ['706px', '336px'],
                //    content: '/DiaoDU/Web/WebForm/InPage/fenquIframe.html'
                //});
                break;
            }
        }
        ...
        switch (index) {
            case 0: {
                ...
                layer.open({
                    ...
                    shadeClose: true, //点击遮罩关闭层
                    area: ['70%', '80%'],
                    content: '/DiaoDU/Web/WebForm/MapTools/layer_yaliAddMid.html?typeIndex=7' + '&id=' + id,
                    success: function () {
    ...
    $('.headerNav li.li_liebiao .childList li').click(function () {
        ...
        switch (index) {
            case 0: {
                ...
                //    shadeClose: true, //点击遮罩关闭层
                //    area: ['70%', '80%'],
                //    content: '/DiaoDU/Web/WebForm/MapTools/yaliLiebiao.html?typeIndex=7' + '&id=' + id,
                //    success: function () {
                //        console.log('click set');
                //    }
                //});
...
function topNavClick() {
    $('.headerNav>li').click(function () {
        ...
        //if (index < 5 || index > 7) {
        //    if (index == 1) {
        //        $('.mapIframe').attr('src', '/DiaoDU/Web/WebForm/InPage/qingpuMapShow.html?id=' + tempID);
        //    }
        //    return;
        //}
        ...
        //    shadeClose: true, //点击遮罩关闭层
        //    area: ['706px', '336px'],
        //    content: '/DiaoDU/Web/WebForm/InPage/'+navArr[index - 4] + 'Iframe.html'
        //});
        ...
        if (index < 5 || index > 7) {
            ...
            if (index == 2) {
                $('.mapIframe').attr('src', '/YCJK/V_CDJK/CDJK');
            }
            if (index == 3) {
                layer.open({
                    type: 2,
                    ...
                    shadeClose: true, //点击遮罩关闭层
                    area: ['706px', '336px'],
                    content: '/DiaoDU/Web/WebForm/InPage/unableIframe.html'
                });
            }
            return;
        }
