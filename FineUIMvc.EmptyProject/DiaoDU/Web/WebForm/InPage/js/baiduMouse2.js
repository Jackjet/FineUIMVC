...
//          
    ...
    DrawingTool.prototype._generalHtml = function (map) {
        ...
        //var texArr=['管线','设备','阀门','户表','水厂','大户表','加压站','水源'];
        var getItem = function (className, drawingType) {
            return '<a charIndex="' + i + '" class="' + className + '" drawingType="' + drawingType + '" href="javascript:void(0)" title="' + tips[drawingType] + '" onfocus="this.blur()"></a>';
        }
    ...
    DrawingTool.prototype._bind = function (panel) {
        ...
        baidu.on(this.panel, 'click', function (e) {
            ...
            //alert(target.getAttribute('drawingType'));
            var drawingType = target.getAttribute('drawingType');
            var charIndex = target.getAttribute('charIndex');
            me.setStyleByDrawingMode(drawingType);
            me._bindEventByDraingMode(drawingType);
        });
    }
    DrawingTool.prototype._bindObjClick = function (obj) {
        var me = this;

        obj.find("li").click(function (e) {
            var drawingType = this.getAttribute('data-drawingtype');
            me.setStyleByDrawingMode(drawingType);
            me._bindEventByDraingMode(drawingType);
        });
